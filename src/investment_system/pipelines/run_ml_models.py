...
df = make_dataset_from_parquet(
    "C:\\Users\\pawel\\Desktop\\Investment_System\\data\\raw\\prices.parquet",
    [1, 5, 15],
    horizon=horizon,
)
...
with open(
    "C:\\Users\\pawel\\Desktop\\Investment_System\\configs\\folds.yaml", "r"
) as f:
...
for name, Model in models.items():
    ...
    for fold in data["folds"]:
        ...
        df_data, portfolio, metrics = run_portfolio_backtest(clean_test_df, fee)
